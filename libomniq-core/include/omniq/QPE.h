...
public:
   ...
   */
  QPE(int num_precision_qubits, int num_eigenstate_qubits,
   ...
   */
  void set_eigenvalues_and_states(
   ...
   */
  int get_total_qubits() const {
    return num_precision_qubits_ + num_eigenstate_qubits_;
  }
};
...
public:
  ...
  void apply(DensityMatrix &state) const;
...
public:
  ControlledUnitaryGate(int control_qubit, int target_start,
                        int num_target_qubits, UnitaryOperator unitary,
                        int power = 1);
