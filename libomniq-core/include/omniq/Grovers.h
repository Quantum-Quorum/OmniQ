...
#ifndef OMNIQ_GROVERS_H
#define OMNIQ_GROVERS_H
...
public:
   ...
   * @param num_solutions Number of solutions (optional, for optimal iteration
   * count)
   */
  GroversAlgorithm(int num_qubits, OracleFunction oracle,
                   int num_solutions = 1);
